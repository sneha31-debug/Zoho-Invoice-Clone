...
import { timeAPI, customerAPI } from '../../services/api';
    ...
    return (
        <div className="fade-in">
            <div className="page-header">
                <div><h1>Time Tracking ({data.total})</h1><span style={{ fontSize: 14, color: 'var(--text-muted)' }}>{totalHours}hrs — ${totalAmount.toLocaleString()}</span></div>
            ...
            <div className="card">
                {data.timeEntries.length === 0 ? (
                    ...
                    <div className="table-container">
                        <table>
                            <thead><tr><th>Date</th><th>Description</th><th>Customer</th><th>Hours</th><th>Rate</th><th>Amount</th><th>Billable</th><th></th></tr></thead>
                            <tbody>
